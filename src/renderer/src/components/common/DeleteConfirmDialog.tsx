      ...
      >
        ...
        <div className="flex justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 bg-card hover:bg-[#333333] rounded-lg transition-colors text-gray-300 text-sm"
          >
            取消
          </button>
          <button
            ...
            className="px-5 py-2 bg-destructive hover:bg-destructive/90 rounded-lg transition-colors text-white text-sm"
          >
            删除
          </button>
        </div>
